...
public class AdaptadorHorariosAlumno extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textViewR = (TextView) vi.findViewById(R.id.idRutHor);
        ...
        holder.textViewR.setText(rutina.get(position));
        if (dias.get(position).contains("L")){
            holder.textViewL.setText("X");
